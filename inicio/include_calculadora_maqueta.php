...
<script type="text/javascript">var id_tipo_prod = new LiveValidation('id_tipo_prod');id_tipo_prod.add( Validate.Presence );</script><br /><br />
					 ...
					 <input id="valor_compra" name="valor_compra" size="50" maxlength="10" class="form-control" style="height:70px; font-size:120%" type="text" value="" title="Ingresa el valor total del producto en D&oacute;lares"  placeholder="Valor del producto + Shipping + TAX" >

					 <br />
  <input name="tipopeso" type="radio" value="k"> Kilogramos/Kgs&nbsp;&nbsp;
     <input name="tipopeso" type="radio" value="l"> Libras 
<input id="peso_compra" name="peso" size="50" maxlength="10" class="form-control" type="text" value="" style="height:70px; font-size:120%"  title="Ingresa el peso de tu producto"  placeholder="0"  >
