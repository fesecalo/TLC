...
//$mensajeemail="Sus credenciales fueron enviadas a su email, revise y vuelva a ingresar;";
	...
	$asuntoe="Nueva Cuenta TLC Landing Venezuela";
...
<table width=99% border=0 align=center cellpadding=10 cellspacing=1 >
 <tr bgcolor=#0161AC> 
	<td colspan=2 align=left><strong><font face=Verdana, Geneva, sans-serif color=#FFFFFF size=+3>Nueva Cuenta de Cliente</font></strong></td>
     ...
     <tr bgcolor=#FFFFFF> 
	<td colspan=2 align=left><font face=Verdana,>Se ha creado una nueva cuenta de cliente desde Landing Venezuela con los siguientes datos:</font></td>
	</tr>
     <tr bgcolor=#FFFFFF> 
...
echo "<script languaje='javascript'>";
echo "top.frames.location.replace('ok_tlc_venezuela.php')";
echo "</script>";
?>
