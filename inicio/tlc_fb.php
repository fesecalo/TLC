...
<div class="brand">
 <div class="container"><img src="images/banner_bf.png" class="img-responsive" alt=""/></div>
</div>
...
<!-- INCLUDE 4 PASOS-->	
<?php include('include_4_pasos_tlc_fb.php'); ?>	
<!--FIN INCLUDE 4 PASOS-->	

      <!-- INCLUDE REGISTRO-->	
<?php include('include_registro_tlc_fb.php'); ?>
<!-- INCLUDE REGISTRO-->	
...
<!-- INCLUDE TRACKING-->	
<?php include('include_4_tr_tlc_fb.php'); ?>
<!-- INCLUDE TRACKING-->	
...
<?php include('include_footer_bottom_fb.php'); ?>
<!-- INCLUDE FOOTER  BOTTOM-->	 
