	 ...
	 <div class="container"> 
	      <div class="single_grid">
       	...
       	<div class="container" style="text-align:left">
            ...
            CONTRATO DE SERVICIO CASILLA INTERNACIONAL TLCCOURIER <br /><br>
...
<strong style="color:#333;">1.- Servicio</strong> <br />
...
El Cliente se hace responsable de la veracidad, exactitud e integridad de la informaci&oacute;n que proporcione a TLCCOURIER para importar sus env&iacute;os y para efectuar las entregas en Chile a la direcci&oacute;n que &eacute;ste le se&ntilde;ale.<br /><br>

<strong style="color:#333;">2.- Direcci&oacute;n f&iacute;sica</strong><br />
...
Las &uacute;nicas limitantes para los paquetes y env&iacute;os que se reciban en la Direcci&oacute;n f&iacute;sica es toda papeler&iacute;a (revistas, diarios, flyers, avisos, etc) que no vengan dentro de una caja y todos aquellos env&iacute;os que est&eacute;n prohibidos por ley.<br /><br>

<strong style="color:#333;">3.- Cumplimiento normativa y autorizaciones</strong><br />
...
T&eacute;rminos del servicio de entrega de USPS (united States Postal Service). El servicio Postal de Estados unidos (USPS) requiere autorizaci&oacute;n de cliente para que sus paquetes sean transportados, de acuerdo a lo exigido a trav&eacute;s del formulario &ldquo;1583&rdquo; indicado en link a continuaci&oacute;n, <a href="https://about.usps.com/forms/ps1583.pdf." target="_blank">https://about.usps.com/forms/ps1583.pdf.</a><br /><br>

<strong style="color:#333;">4.- Documentaci&oacute;n</strong><br />
...
Si transcurridos 30 d&iacute;as desde su solicitud no han sido presentados los antecedentes requeridos, TLCCOURIER declarar&aacute; abandonados los productos y proceder&aacute; a disponer de ellos para cubrirse de los cr&eacute;ditos devengados en su favor.<br /><br>

<strong style="color:#333;">5.- Tarifas, costos y pago</strong><br />
A trav&eacute;s del sitio <a href="www.tlccourier.c">www.tlccourier.cl</a> el Cliente podr&aacute; acceder a un sistema referencial de simulaci&oacute;n de cargos de sus env&iacute;os al cual deber&aacute;n ingresarse las caracter&iacute;sticas exactas del producto que se desea importar. El Cliente declara conocer y aceptar que en caso que los datos ingresados no sean ajustados a las caracter&iacute;sticas como peso, origen, precio y destinaci&oacute;n de los productos, el valor final del servicio ofrecido por TLCCOURIER podr&iacute;a variar, ya sea en contra o en favor del Cliente. <br />
...
Este plazo es inimpugnable, de d&iacute;as corridos y no est&aacute; condicionado al pago del env&iacute;o por parte del cliente.<br /><br>

<strong style="color:#333;">9.- Cobertura adicional</strong><br />
...
<br />
Para m&aacute;s informaci&oacute;n respecto a nuestras condiciones de aplicaci&oacute;n de garant&iacute;a y protecci&oacute;n adicionales, consulte <a href="www.tlccourier.c">www.tlccourier.c</a>l<br /><br>

<strong style="color:#333;">10.- Indemnizaci&oacute;n</strong><br />
...
<strong style="color:#333;">11- Ley Aplicable</strong><br />
