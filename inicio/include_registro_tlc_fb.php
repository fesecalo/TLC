...
<div class="contact">
      	<div class="container">
      	   <div class="register" style="margin-left:20px;">
		  	 <form action="enviar_tlc_fb.php" method="post" enctype="multipart/form-data" onSubmit="javascript:return valida()" class="row" name="form1">

				 <div class="register-top-grid">
					<h3>REG&Iacute;STRATE GRATIS</h3>
					 <div>
                     <input name="promoap" size="60" maxlength="100" class="form-control" type="hidden" value="land_c_FB" >
