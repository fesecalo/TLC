...
include("../lib/conf.php");
	...
	$mensajeemail="Contacto desde TLC Courier Web";
	$respondere="atancionalcliente@tlccourier.cl";
	...
	Departamento: ".$_POST['department']."<br>
...
echo "top.frames.location.replace('ok_contacto.php')";
echo "</script>";
?>
