...
<div class="block type-2 scroll-to-block" data-id="about">
                <div class="container-fluid type-2-text">
                    <div class="row">
                        <div class="image-block mob-hide wow fadeInLeft" data-wow-delay="0.3s">
                            <img class="center-image" src="img/content/Home-1/big_content_image_1.jpg" alt=""/>
                        </div>
                        <div class="col-md-4 col-md-offset-7 col-sm-12 col-sm-offset-0 wow fadeInRight" data-wow-delay="0.3s">
                            <article class="normall">
                                <h2 class="h2 titel-left">CASILLA personas</h2>
                                <p>Ten tu casilla en MIAMI para comprar en las mejores tiendas de USA, es completamente gratis.</p>
 ...
 <!-- PROMOCODE-->                           
<input name="promoap" size="60" maxlength="100" class="form-control" type="hidden" value="basico_persona_2019" >
...
<input class="required" style="border:1px solid #999;  width: 95%;" type="text" placeholder="Nombre" value="" id="firstName" name="nombre_usu" required="required"  >

<input class="required" style="border:1px solid #999;  width: 95%;" type="text" placeholder="Apellido" value="" id="lastName" name="apellidos_usu" required="required" >

<input class="required" style="border:1px solid #999; " type="text" placeholder="RUT" value=""  name="rut_usu" id="rut_usu"   oninput="checkRut(this)" required="required">  
