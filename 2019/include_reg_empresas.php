                ...
                <div class="container-fluid type-2-text">
                    <div class="row">
                        <div class="image-block mob-hide wow fadeInLeft" data-wow-delay="0.3s">
                            <img class="center-image" src="img/content/Home-1/big_content_image_3.jpg" alt=""/>
                        </div>
                        <div class="col-md-4 col-md-offset-7 col-sm-12 col-sm-offset-0 wow fadeInRight" data-wow-delay="0.3s">
                            <article class="normall">
                                <h2 class="h2 titel-left">CASILLA EMPRESAS</h2>
                                <p>Ten una casilla en MIAMI para tu empresa, es completamente gratis.</p>
                                <div class="col-md-7 col-md-offset-1 wow fadeInRight" data-wow-delay="0.3s" style="width:100%;">
                            
                            <form action="enviar.php" method="post" enctype="multipart/form-data" onSubmit="javascript:return valida()"  name="form1">
 
 <!-- PROMOCODE-->                           
<input name="promoap" size="60" maxlength="100" class="form-control" type="hidden" value="basico_empresa_2019" >



                            
<input class="required"  style="border:1px solid #999; width: 95%;" placeholder="email" value="" id="email_usu" name="email_usu"  type="email" required="required"  >
                            
<input class="required" style="border:1px solid #999;  width: 95%;" type="text" placeholder="Nombre Empresa" value="" id="firstName" name="empresa_usu" required="required"  >

<input class="required" style="border:1px solid #999;  width: 95%;" type="text" placeholder="Nombre Contacto" value="" id="lastName" name="nombre_usu" required="required" >
<input class="required" style="border:1px solid #999;  width: 95%;" type="text" placeholder="Apellido Contacto" value="" id="lastName" name="apellidos_usu" required="required" >

<input class="required" style="border:1px solid #999; " type="text" placeholder="RUT Empresa" value=""  name="rut_usu" id="rut_usu"   oninput="checkRut(this)" required="required">  
<script src="validarRUT.js"></script>

<input class="required" style="border:1px solid #999; padding:6px 15px; 
input[type=number]::-webkit-inner-spin-button, 
input[type=number]::-webkit-outer-spin-button { 
  -webkit-appearance: none; 
  margin: 0; 
input[type=number] { -moz-appearance:textfield;  " type="number" placeholder="Tel&eacute;fono" value="" name="fono_usu"  id="fono_usu" required="required"   />

<input class="required" id="direccion" style="border:1px solid #999; width: 95%;" type="text" placeholder="Direcci&oacute;n" value="" name="direccion_usu" required="required"  >


                                
                                
<select name="categoria" class="form-control"    id="id_comuna_scl" title="Sellecciona una Regi&oacute;n" onChange="act_categoria(this);" required="required" style="padding:8px 15px;outline: none;color: #666; background: #fff; border:solid 1px #999 ;width: 95%;">
...
<?php  mysqli_query($connection ,"SET NAMES 'utf8'"); $result4 = "select * from region where id_region<>0";
	...
	while ($Rs2 = mysqli_fetch_assoc($arr_vend)) {?>
      ...
      <select name="subcategoria" class="form-control" title="Selecciona una Comuna" id="subcategoria" style="padding:8px 10px;outline: none;color: #666666; background: #fff; border:solid 1px #999 ;width: 95%;" required="required"  >
                     ...
                     <div class="clearfix"> </div>
					   <a class="news-letter" href="#condiciones" onClick="aparecer('condiciones');ocultar('politica');">
						 <label class="checkboxx"><input type="checkbox" name="checkbox" checked="" required="required"><i> </i>Acepto Los T&eacute;rminos y Condiciones</label>
					   </a>       
...
<!-- DIV CONDICIONES-->               
<div id="condiciones">
<a href="#condiciones" style="float:right; color:#036; font-weight:bold;" onClick="ocultar('condiciones');">CERRAR</a>

<p style="font-size:12px; font-weight:bold;">CONTRATO DE SERVICIO CASILLA INTERNACIONAL TLCCOURIER</p>
...
<div class="button">ENVIAR<input type="submit" value="Registrarme" /></div>
                                </div>
                                
                                <input type="hidden" name="mailto" value="finanzas@tlccourier.cl" style="display: none;" />
