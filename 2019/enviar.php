...
//INSERTO datos de usuario
	...
	if ($_POST['promoap'] == "basico_persona_2019"){

		$promoap = "BASICO-P/19"; //EDITAR PROMOCODE//

		$tipo = "PERSONA"; //TIPO DE CUENTA//

	}

	if ($_POST['promoap'] == "basico_empresa_2019"){

		$promoap = "EMPRESA-P/19"; //EDITAR PROMOCODE//

		$tipo = "EMPRESA"; //TIPO DE CUENTA//
	...
	(id_cliente,promoap,tipo,email,nombre_empresa,nombre,apellidos,rut,telefono,direccion,id_region,id_comuna)	VALUES	

	('".$numerocliente."','".$promoap."','".$tipo."','".$_POST['email_usu']."','".$_POST['empresa_usu']."','".$_POST['nombre_usu']."','".$_POST['apellidos_usu']."','".$_POST['rut_usu']."','".$_POST['fono_usu']."','".$_POST['direccion_usu']."',".$_POST['categoria'].",".$_POST['subcategoria'].") ";
...
<table width=99% border=0 align=center cellpadding=10 cellspacing=1 >
 ...
 <tr bgcolor=#0161AC> 
  ...
  <tr bgcolor=#FFFFFF> 
	...
	<td width=25% align=right> <font face=Verdana, Geneva, sans-serif>Tipo:</font></td>

	<td width=75% align=left><font face=Verdana, Geneva, sans-serif>&nbsp;".$tipo."</font></td>
