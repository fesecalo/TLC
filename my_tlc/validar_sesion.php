...
error_reporting(E_ALL);
	...
	$db->prepare('SELECT * FROM gar_usuarios WHERE email=:usuario AND status=1');
		...
		if($res[0]->bloqueado_intentos==5){
			...
			if(empty($res_login)){
				...
				if(empty($sql_sesion)){
					...
					// VARIABLES DE SESION
					$_SESSION['numero_cliente']=$n_cliente;
					...
					// VARIABLES DE SESION PARA ADMINISTRADORES
					$_SESSION['id_usu']=$n_cliente;
					$_SESSION['usuario']=$usuario;
					// FIN VARIABLES DE SESION PARA ADMINISTRADORES
