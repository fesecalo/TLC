<?php
	...
	$sql_valijas=$db->get_results("SELECT * FROM valijas WHERE id_vuelo='0' AND status_valija='1' ORDER BY id_valija ASC");
?>
<!DOCTYPE html>
...
<body>
	...
	<form action="procesa_agregar_valija.php" id="procesa_vuelo" name="procesa_vuelo" method="POST" >
		<table>
			<tr>
				<td>Check</td>
				<td>Cincho</td>
		...
		<table>
			<tr>
				...
				<td><input type="button" id="btn"  name="btn" class="button solid-color"  value="Agregar valija"></td>
			</tr>
		</table>
	</form>
	<!-- Fin de contenido -->
	...
	<br><br>
	<center><a href="<?php echo $conf['path_host_url'] ?>/miami/vuelos/editar_vuelo/editar_vuelo.php?vuelo=<?php echo $id_vuelo;?>" class="button solid-color">VOLVER</a></center>
	<br><br><br><br><br><br>
