<?php
	...
	$db->prepare("SELECT * FROM vuelos 
		...
		AND date(fecha_salida) BETWEEN :inicio AND :fin
		AND eliminado=0
...
<body>
	...
	<table>
		...
		<tr>
			...
			<td><?php echo date("d/m/Y H:i:s",strtotime($vuelos->fecha_salida)); ?></td>
		</tr>
		<tr>
			<td colspan="8"><hr size="1" color="#FF6600" /></td>
		</tr>
	...
	Exportar
	<br/>
	<a href="reportes_excel/reporte_excel_vuelos.php?fecha_inicio=<?php echo $_GET['fecha_inicio']; ?>&fecha_termino=<?php echo $_GET['fecha_termino']; ?>"><img src="<?php echo $conf['path_host_url'] ?>/img/excel.jpg" width="30" height="30"> Excel</a>
	<?php } ?>	
