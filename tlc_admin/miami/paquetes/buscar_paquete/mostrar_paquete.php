...
<!-- Fin datos cliente -->
	<?php if($eliminado==1){ ?>
		<center><h2>PAQUETE ELIMINADO</h2></center><br>
	<?php } ?>
	...
	<table>
		<tr align="left">
			...
			<td>:<?php echo $conf['path_cuenta'].$id_cliente; ?></td>
		</tr>
		<tr align="left">
		...
		<tr align="left">
			<td>Medidas (inch)</td>
			<td>
				Largo: <?php echo $largo/2.54; ?><br>
				Ancho: <?php echo $ancho/2.54; ?><br>
				Alto: <?php echo $alto/2.54; ?><br>
			</td>
		</tr>
	</table>
	...
	<center><a href="<?php echo $conf['path_host_url'] ?>/miami/paquetes/buscar_paquete/inicio_escanear_codigo.php" class="button solid-color">VOLVER</a></center>
