		...
		<form id="registrar" name="registrar" action="procesa_cambiar_cliente.php" method="post" enctype="multipart/form-data" autocomplete="off">
			...
			<table>
				<tr>
					...
					<td><a href="<?php echo $conf['path_host_url'] ?>/miami/paquetes/editar_paquete/editar_paquete.php?paquete=<?php echo $id_paquete; ?>" class="button solid-color">VOLVER</a></td>
				</tr>
			</table>
		</form>
	</center>
