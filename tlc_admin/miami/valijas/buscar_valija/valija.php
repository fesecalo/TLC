<?php
	...
	$sql_valija_abierta=$db->get_results("SELECT * FROM valijas WHERE status_valija=1 ORDER BY id_valija DESC");
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#buscar").click(function(){
                ...
                $("#valijas").load("tabla_valijas.php?fecha_inicio="+fecha_inicio+"&fecha_termino="+fecha_termino); 
            });
        });
    </script>
    <!-- fin validaciones js -->
