<?php
	...
	$db->prepare("SELECT 
		...
		WHERE paquete.id_valija=:id_valija
...
<body>
	...
	<center><h2>Valija <?php echo $sql_paquete[0]->cincho; ?></h2></center>
	...
	<center><a href="<?php echo $conf['path_host_url'] ?>/miami/valijas/buscar_valija/valija.php" class="button solid-color">VOLVER</a></center>
	<br>
	<br>
<!-- Fin de contenido -->
