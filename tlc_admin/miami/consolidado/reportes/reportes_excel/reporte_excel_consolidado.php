...
//PARAMENTROS	
	...
	//CABECERA
	$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A1', 'Consolidados procesados')
	...
	//TITULOS
	$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A7', 'Consolidados procesados')
				->setCellValue('A8', 'TLC Tracking Consolidado')
				->setCellValue('B8', 'Peso total(kg)')
				->setCellValue('C8', 'Paquetes')
	...
	//FORMATO DE LOS TITULOS
			...
			foreach ($sql_consolidado_cerrado as $consolidado){
				$objPHPExcel->setActiveSheetIndex(0)
							->setCellValue('A'.$y, $consolidado->codigo_consolidado)
							->setCellValue('B'.$y, $consolidado->peso_kilos/0.45)
							->setCellValue('C'.$y, $consolidado->numero_paquetes)
							->setCellValue('D'.$y, date("d/m/Y H:i:s",strtotime($consolidado->fecha)));
				$y=$y+1;
			}

			$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A'.($y+1),"Total de registros: ".count($sql_consolidado_cerrado));
...
header('Content-Disposition: attachment;filename="Consolidados.xls"');
