    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#buscar").click(function(){
                ...
                $("#consolidado").load("reporte_consolidados.php?fecha_inicio="+fecha_inicio+"&fecha_termino="+fecha_termino);
            });
        });
    </script>
    <!-- fin validaciones js -->
            ...
            <tr>
                ...
                <td>
                    <select name="opcion" id="opcion" class="form-control">
                        ...
                        <option value="1">Consolidados procesados</option>
                    </select>
                </td>
                <tr class="date">
                    <td>Inicio</td>
