    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#buscar").click(function(){
                ...
                $("#consolidados").load("tabla_consolidados_cerrados.php?fecha_inicio="+fecha_inicio+"&fecha_termino="+fecha_termino); 
            });
        });
    </script>
    <!-- fin validaciones js -->
...
<body>
	...
	<!--Inicio Contenido -->
	<h2>Buscar consolidado para editar</h2>
	<center>
        <table >
            <tr>
                <tr class="date">
