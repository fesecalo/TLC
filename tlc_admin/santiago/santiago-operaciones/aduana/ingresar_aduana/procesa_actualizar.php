<?php
	...
	if (empty($sql_paquete)) {
		...
		foreach ($sql_paquete as $key => $paquete) {
			...
			$db->prepare("UPDATE paquete SET status=:estado WHERE id_paquete=:id");
            ...
            // include $conf['path_host'].'/include/mail/email_retenido_aduana_chile.php';
            // fin funcion que envia el email
		}
	}
