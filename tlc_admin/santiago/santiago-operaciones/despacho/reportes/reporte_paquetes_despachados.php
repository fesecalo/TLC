...
<body>
	...
	<center>
		<div id="sesion">
			<p>Muestra todos los paquetes que han sido despachados</p>
		</div>
	</center>
	...
	<table>
		...
		<?php $x=1; foreach ($sql_paquete as $key => $paquete) {  ?>
			<tr>
				...
				<td><?php echo $paquete->nombreCliente.' '.$paquete->apellidosCliente; ?></td>
				...
				<td><?php echo $paquete->nombreUsuario.' '.$paquete->apellidosUsuario; ?></td>
			</tr>
			<tr>
				<td colspan="14"><hr size="1" color="#FF6600" /></td>
			</tr>
	...
	<br/>
	Total de vuelos: <?php echo count($sql_paquete); ?>
	
	<br/>
	<br/>
	Exportar
	<br/>
	<a href="reportes_excel/reporte_excel_paquetes_despachados.php?fecha_inicio=<?php echo $_GET['fecha_inicio']; ?>&fecha_termino=<?php echo $_GET['fecha_termino']; ?>"><img src="<?php echo $conf['path_host_url'] ?>/img/excel.jpg" width="30" height="30"> Excel</a>
