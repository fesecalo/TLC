    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#buscar").click(function(){
                ...
                switch(op){
                    case '1':
                    $("#paquetes").load("reporte_paquetes_despachados.php?fecha_inicio="+fecha_inicio+"&fecha_termino="+fecha_termino);
                    break;
...
<body>
    ...
    <!--Inicio Contenido -->
    <h2>REPORTE PAQUETES DESPACHADOS</h2>
            ...
            <tr>
                ...
                <td>
                    <select name="opcion" id="opcion" class="form-control">
                        ...
                        <option value="1">Paquetes despachados</option>
                    </select>
                </td>
                <tr class="date">
                    <td>Inicio</td>
