...
<!--Inicio Contenido -->
	...
	<center>
		<a href="<?php echo $conf['path_host_url'] ?>/santiago/santiago-operaciones/EditarEstado/editar_paquete/mostrar_paquete.php?paquete=<?php echo $id; ?>" class="button solid-color">VOLVER</a>
