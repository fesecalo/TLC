...
<!--Inicio Contenido -->
	...
	<table>
		<tr align="left">
			...
			<td><strong><?php echo $estado; ?></strong>   <a href="<?php echo $conf['path_host_url'] ?>/santiago/santiago-operaciones/EditarEstado/editar_paquete/editar_estado/editar_estado.php?id=<?php echo $id; ?>" class="button solid-color">Cambiar estado</a></td>
		</tr>
		<tr align="left">
	...
	<center><a href="<?php echo $conf['path_host_url'] ?>/santiago/santiago-operaciones/EditarEstado/editar_paquete/inicio_escanear_codigo.php" class="button solid-color">VOLVER</a></center>
