	...
	//FORMATO DE LOS TITULOS
			...
			foreach ($sql_paquete as $key => $paquete) {
				...
				$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue('I'.$y, date("d/m/Y H:i:s",strtotime($paquete->fecha)));
...
header('Content-Disposition: attachment;filename="paquetes_counter.xls"');
