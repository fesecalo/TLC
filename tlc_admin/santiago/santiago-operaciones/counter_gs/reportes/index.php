    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#buscar").click(function(){
                ...
                switch(op){
                    case '1':
                    $("#paquetes").load("tabla_paquetes_counter.php?fecha_inicio="+fecha_inicio+"&fecha_termino="+fecha_termino);
                    break;

                    case '2':
                    $("#paquetes").load("tabla_paquetes_procesando.php?fecha_inicio="+fecha_inicio+"&fecha_termino="+fecha_termino);
                    break;
...
<body>
   ...
   <!-- menu-->
    ...
    <!--Inicio Contenido -->
    <h2>REPORTES PAQUETES EN COUNTER</h2>
            ...
            <tr>
                ...
                <td>
                    <select name="opcion" id="opcion" class="form-control">
                        ...
                        <option value="1">Paquetes en counter</option>
                        <option value="2">Paquetes procesando en SCL</option>
                    </select>
                </td>
                <tr class="date">
                    <td>Inicio</td>
