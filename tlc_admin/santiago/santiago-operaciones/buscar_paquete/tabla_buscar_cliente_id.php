...
<!--Inicio Contenido -->
	...
	<table>
		...
		<tr>
			...
			<td>
				<a class="button solid-color" href="<?php echo $conf['path_host_url'] ?>/santiago/buscar_paquete/tabla_buscar_paquete.php?codigo=<?php echo $usuario->id_usuario; ?>">Ver paquetes</a>
			</td>
		</tr>
		<tr>
