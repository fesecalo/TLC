<?php
	...
	$sql_vuelo=$db->get_results("SELECT * FROM vuelos WHERE id_status_vuelo=2 ORDER BY id_vuelos DESC");
?>
...
<body>
	...
	<table>
		...
		<tr>
			...
			<?php if( $vuelos->id_status_vuelo==1){ ?>
				<td><strong>Vuelo confirmado</strong></td>
			<?php }else{ ?>
				<td><strong>En vuelo</strong></td>
			<?php } ?>
