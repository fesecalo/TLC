...
//PARAMENTROS	
	...
	$objPHPExcel->setActiveSheetIndex(0)
				...
				->setCellValue('B8', 'Tienda')
				->setCellValue('C8', 'Courier')
				->setCellValue('D8', 'Tracking Eshopex')
				->setCellValue('E8', 'Nombre del Cliente')
				->setCellValue('F8', 'Number Cliente')
				->setCellValue('G8', 'Description')
				->setCellValue('H8', 'Valor USD');
	...
	//FORMATO DE LOS TITULOS
			...
			foreach ($sql_paquete as $paquete){
				...
				$objPHPExcel->setActiveSheetIndex(0)
					...
					->setCellValue('E'.$y, $paquete->consignatario)
