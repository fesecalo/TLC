...
//PARAMENTROS	
	...
	$objPHPExcel->setActiveSheetIndex(0)
				...
				->setCellValue('C8', 'Tracking Eshopex')
				->setCellValue('D8', 'Nombre del Cliente')
				->setCellValue('E8', 'CHI')
				->setCellValue('F8', 'Descripción')
				->setCellValue('G8', 'Peso (KG)')
	...
	//FORMATO DE LOS TITULOS
			...
			foreach ($sql_paquete as $key => $paquete) {
				...
				$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue('D'.$y, $paquete->consignatario)
							->setCellValue('E'.$y, $paquete->id_usuario)
							->setCellValue('F'.$y, $paquete->descripcion_producto)
							->setCellValue('G'.$y, $paquete->peso)
