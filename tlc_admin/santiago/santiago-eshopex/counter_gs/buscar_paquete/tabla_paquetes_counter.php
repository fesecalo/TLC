	...
	<table>
		...
		<?php $x=1; foreach ($sql_paquete as $key => $paquete) {  ?>
			<tr>
				...
				<td>
					<a href="<?php echo $conf['path_host_url'] ?>/santiago/santiago-eshopex/counter_gs/buscar_paquete/mostrar_paquete.php?paquete=<?php echo $paquete->id_paquete; ?>&op=1" class="button solid-color">VER</a>
				</td>
