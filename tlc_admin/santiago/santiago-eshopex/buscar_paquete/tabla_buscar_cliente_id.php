...
<!--Inicio Contenido -->
	...
	<table>
		...
		<tr>
			<td><?php echo $c; ?></td>
			<td>CHI - <?php echo $usuario->id_usuario; ?></td>
			<td><?php echo $usuario->nombre.' '.$usuario->apellidos; ?></td>
			<td><?php echo $usuario->rut; ?></td>
			<td><?php echo $usuario->email; ?></td>
			<td><?php echo $usuario->telefono; ?></td>
			<td>
				<a class="button solid-color" href="<?php echo $conf['path_host_url'] ?>/santiago/santiago-eshopex/buscar_paquete/tabla_buscar_paquete.php?codigo=<?php echo $usuario->id_usuario; ?>">Ver paquetes</a>
			</td>
		</tr>
		<tr>
