...
<!-- Fin datos cliente -->
	...
	<center><a href="<?php echo $conf['path_host_url'] ?>/santiago/santiago-eshopex/buscar_paquete/buscar_paquete.php" class="button solid-color">VOLVER</a></center>
