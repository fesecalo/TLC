...
<body>
	...
	<center>
		<div id="sesion">
			<p>Muestra todos los paquetes que estan retenidos en aduana Chilena.</p>
		</div>
	</center>
	...
	Exportar
	<br/>
	<a href="reportes_excel/reporte_excel_retenidos_aduana.php"><img src="<?php echo $conf['path_host_url'] ?>/img/excel.jpg" width="30" height="30"> Excel</a>
