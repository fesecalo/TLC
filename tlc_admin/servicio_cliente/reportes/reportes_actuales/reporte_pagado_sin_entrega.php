<?php
	...
	$sql_paquete=$db->get_results("SELECT 
		...
		WHERE paquete.envio_entregado=0
...
<body>
	...
	Exportar
	<br/>
	<a href="reportes_excel/reporte_excel_pagado_sin_entrega.php"><img src="<?php echo $conf['path_host_url'] ?>/img/excel.jpg" width="30" height="30"> Excel</a>
