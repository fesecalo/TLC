...
//PARAMENTROS	
	...
	$sql_paquete=$db->get_results("SELECT 
        ...
        INNER JOIN status_log AS historial ON (historial.id_paquete=paquete.id_paquete AND historial.id_tipo_status=6)
...
header('Content-Disposition: attachment;filename="Paquetes_entregados.xls"');
