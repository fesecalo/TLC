...
//PARAMENTROS	
	...
	$sql_paquete=$db->get_results("SELECT 
        ...
        INNER JOIN status_log AS historial ON (historial.id_paquete=paquete.id_paquete AND historial.id_tipo_status=3)
		...
		WHERE paquete.status=3
		AND paquete.id_valija!=0
		AND paquete.id_vuelo!=0
		AND vuelo.id_status_vuelo=2
...
header('Content-Disposition: attachment;filename="Paquetes_en_vuelo.xls"');
