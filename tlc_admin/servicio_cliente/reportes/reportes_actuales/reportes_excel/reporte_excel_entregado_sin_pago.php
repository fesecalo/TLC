...
//PARAMENTROS	
	...
	//CABECERA
	$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A1', 'Paquetes entregados sin pago')
				->setCellValue('A2', 'Fecha de informe: '.date('d/m/Y'))
				->setCellValue('A3', $conf['path_company_name']);

	//TITULOS
	$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A7', 'Paquetes entregados sin pago')
...
header('Content-Disposition: attachment;filename="Paquetes_entregados_sin_pago.xls"');
