...
//PARAMENTROS	
	...
	$db->prepare("SELECT 
        ...
        INNER JOIN status_log AS historial ON (historial.id_paquete=paquete.id_paquete AND historial.id_tipo_status=13)
	...
	//CABECERA
	$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A1', 'Paquetes listo embarque')
	...
	//TITULOS
	$objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A7', 'Paquetes listo embarque')
...
header('Content-Disposition: attachment;filename="Paquetes_listo_embarque.xls"');
