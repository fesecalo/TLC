...
<body>
	...
	<center>
		<div id="sesion">
			<p>Muestra todos los paquetes que han sido prealertados por los clientes en un rango de fechas</p>
		</div>
	</center>
	...
	Exportar
	<br/>
	<a href="reportes_excel/reporte_excel_prealerta.php?fecha_inicio=<?php echo $_GET['fecha_inicio']; ?>&fecha_termino=<?php echo $_GET['fecha_termino']; ?>"><img src="<?php echo $conf['path_host_url'] ?>/img/excel.jpg" width="30" height="30"> Excel</a>
