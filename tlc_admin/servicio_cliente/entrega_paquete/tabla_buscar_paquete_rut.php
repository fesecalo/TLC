...
<!--Inicio Contenido -->
	<table>
		<tr>
			<td colspan="8" >Archivos cargados</td>
		</tr>
		<tr>
			<td>N &deg;</td>
			<td>N &deg; cuenta</td>
		...
		<tr>
			...
			<td><a href="mostrar_paquete.php?id=<?php echo $paquete->id_paquete; ?>" class="button solid-color">VER</a></td>
		</tr>
		<tr>
