...
<body>
	...
	<center>
		...
		<iframe src="<?php echo $conf['path_host_url'] ?>/servicio_cliente/caja/recibo_dinero/recibo_dinero_pdf.php?num_recibo=<?php echo $id_transaccion ?>" style="width:800px; height:1200px;" frameborder="0">
		</iframe>
	</center>
	<!-- Fin de contenido -->
