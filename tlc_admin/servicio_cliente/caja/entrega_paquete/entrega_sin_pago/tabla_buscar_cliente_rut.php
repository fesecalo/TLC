...
<!--Inicio Contenido -->
	...
	<table>
		...
		<tr>
			...
			<td>
				<a class="button solid-color" href="<?php echo $conf['path_host_url'] ?>/servicio_cliente/caja/entrega_paquete/entrega_sin_pago/tabla_entregar_paquete.php?codigo=<?php echo $usuario->id_usuario; ?>">Ver paquetes</a>
			</td>
		</tr>
		<tr>
