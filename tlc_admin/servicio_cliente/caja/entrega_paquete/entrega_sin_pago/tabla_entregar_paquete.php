	...
	$(document).ready(function(){
		...
		$("#quitarTodo").click(function(){
	 	...
	 	$("#entregar_paquetes").click(function(){
	 		if (confirm('Los paquetes seleccionados seran entregados sin realizar un pago. Desea continuar?')){
...
<body>
	...
	<!--Inicio Contenido -->
	<h2>ENTREGAR PAQUETE SIN PAGO</h2>
	...
	<form id="entregar" name="entregar" action="procesa_entregar.php" method="post" >
		...
		<center><input type="button" class="button solid-color" name="entregar_paquetes" id="entregar_paquetes" value="Confirmar Entrega Sin Pago"></center>
	</form>
	<!-- Fin de contenido -->
