...
<h1>EDITAR PAQUETE</h1>
	...
	<table>
		...
		<tr align="left" class="medidas">
			...
			<td>
				Largo<input type="text" id="largo" name="largo" maxlength="100" value="<?php echo $largo; ?>">
				Ancho<input type="text" id="ancho" name="ancho" maxlength="100" value="<?php echo $ancho; ?>">
				Alto<input type="text" id="alto" name="alto" maxlength="100" value="<?php echo $alto; ?>">
			</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			<?php if($eliminado==0){ ?>
				...
				<td><a href="<?php echo $conf['path_host_url'] ?>/servicio_cliente/editar_paquete/eliminar_paquete.php?id_paquete=<?php echo $id_paquete; ?>" class="button solid-color-danger">ELIMINAR</a></td>

				<td><a href="<?php echo $conf['path_host_url'] ?>/servicio_cliente/editar_paquete/buscar_paquete.php" class="button solid-color">VOLVER</a></td>
			<?php }else{ ?>
				<td><a href="<?php echo $conf['path_host_url'] ?>/servicio_cliente/editar_paquete/buscar_paquete.php" class="button solid-color">VOLVER</a></td>
			<?php } ?>
		</tr>
