...
//INSERTO datos
	...
	VALUES
	('".$numerocliente."','EMPRESA','".$_POST['c_promoap']."','".$_POST['c_email']."','".$_POST['c_nombre']."','".$_POST['c_apellidos']."','".$_POST['c_rut']."','".$_POST['c_telefono']."','".$_POST['c_direccion']."','".$_POST['categoria']."','".$_POST['subcategoria']."')";
	//echo $q_insert;
